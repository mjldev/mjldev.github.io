...
const blog = () => {
  return (
    <div>
      <header className="flex justify-center w-full h-auto min-w-screen bg-[url('https://picsum.photos/760/536?grayscale=3')] bg-no-repeat bg-cover bg-center relative">
        <HeaderItem title="Our Blog" />
      </header>
      <main className="flex flex-col justify-center px-4 md:px-10 lg:px-20 xl:px-40 py-4 md:py-4 lg:py-10 xl:py-20 relative">
        <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 xl:grid-cols-3 gap-x-2">
          <BlogItem
            img="https://picsum.photos/760/536?grayscale=4"
            title="Lorem Ipsum"
            alt="Lorem 1"
