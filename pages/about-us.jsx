    ...
    <div>
      ...
      <main className="flex flex-col justify-center px-4 md:px-10 lg:px-20 xl:px-40 py-4 md:py-4 lg:py-10 xl:py-20 relative min-h-screen">
        <p>
          ...
          nesciunt incidunt excepturi perspiciatis voluptas at! Vero ut minima
          ad iste. Rerum expedita architecto ipsam perferendis itaque
          distinctio! Voluptate, aut cumque!
        </p>
      </main>
      <Footer />
    </div>
