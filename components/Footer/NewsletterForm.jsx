...
const NewsletterForm = ( { status, message, onValidated }) => {
  ...
  return (
    <div>
      <h3 className="text-2xl lg:text-3xl xl:text-3xl mb-3">Subscribe to newsletter</h3>
      <div className="flex newsletter-input-fields">
        ...
        <div className="button-wrap wp-block-button">
          <button className="cursor-pointer	text-white bg-gray-700 border-0 py-2 px-5 focus:outline-none hover:opacity-90" onClick={handleFormSubmit}>
            Submit
          </button>
        </div>
      </div>
