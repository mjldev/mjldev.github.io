...
const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-white">
      <div className="container max-w-full px-5 laptop:px-10 relative bg-white z-20">
        <div className="flex justify-between py-5">
          ...
          <div className="menu hidden tablet:flex">
            <ul className="flex justify-center gap-x-8 items-center">
      ...
      >
        <ul className="flex justify-center flex-col text-center bg-white w-full border-y translate-x-0">
          <NavbarLink url="#">MENU</NavbarLink>
          <NavbarLink url="#">BLOG</NavbarLink>
          <NavbarLink url="#">ABOUT US</NavbarLink>
          <NavbarLink url="#">CONTACT US</NavbarLink>
